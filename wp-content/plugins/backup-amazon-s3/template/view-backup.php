                                ...
                                <table class="form-table stat-table-registr" style="margin-top:2px">
                                    <tbody>
                                        ...
                                        <tr valign="top">
                                         ...
                                         <tr valign="top">
                                            <th scope="row">                                                                                                                                
                                                <label for="admin_menu">Appear in menu for admins only</label>        
                                            </th>
                                            <td>
                                               <input type="checkbox" value="1" id="admin_menu" name="admin_menu" <?php echo isset($amazon_option['admin_menu']) && $amazon_option['admin_menu'] == 1  ? 'checked="checked"' : ''; ?>> 
                                            </td>
                                        </tr>
