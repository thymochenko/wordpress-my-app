...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'avata' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'avata' ) ) ) );
...
function customizer_library_get_google_font_uri( $fonts ) {
	...
	$subset = avata_option( 'font-subset', customizer_library_get_default( 'font-subset' ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'avata' ),
		'cyrillic'     => __( 'Cyrillic', 'avata' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'avata' ),
		'devanagari'   => __( 'Devanagari', 'avata' ),
		'greek'        => __( 'Greek', 'avata' ),
		'greek-ext'    => __( 'Greek Extended', 'avata' ),
		'khmer'        => __( 'Khmer', 'avata' ),
		'latin'        => __( 'Latin', 'avata' ),
		'latin-ext'    => __( 'Latin Extended', 'avata' ),
		'vietnamese'   => __( 'Vietnamese', 'avata' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'avata' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'avata' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'avata' ),
