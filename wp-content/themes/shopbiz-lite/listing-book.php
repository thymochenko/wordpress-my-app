       ...
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         ...
         src="http://localhost/wp-content/themes/omega/images/DOCKER-EBOOK-LOGO.jpg"
          ...
          <div style="margin-top:-35px;" class="modal-body">
            <form id="modal-ebook-download_" action="http://localhost/wp-content/themes/shopbiz-lite/contactForm.php" name="_modal-sqz-pg"  method="post">
