      ...
      <div class="row">
        <div class="col-md-6 col-xs-12 col-sm-6">
          <ul class="info-left">
            ...
            <li><a href="mailto:contato@gtimocabral.com" title="Mande-me um email"><i class="fa"></i>contato@timocabral.com</a></li>
          </ul>
        </div>
        <div class="col-md-6 col-xs-12 col-sm-6">
              ...
              <div class="description">
                <p>Ensinando, Desenvolvendo e Inovando pensando em você</p>
                            ...
                            <a class="btn btn-tislide"
														 href="<?php echo get_site_url(); ?>/sobre/" > <span style="color:#303f9f">Saiba mais </span></a>
                            <a class="btn btn-tislider-two"
														 href="<?php echo get_site_url(); ?>/cursos/"> veja nossos cursos! </a>
                          </div>
          </div>
        </div>
      </div>
