...
if ( $query->have_posts() ) :
	while ( $query->have_posts() ) : $query->the_post();
		...
		$sm_image_url = wp_get_attachment_image_src( get_post_thumbnail_id( $query->ID ), 'small' );
		echo '<a href="' . get_the_permalink() . '"><img width="190" height="200" src="'. $sm_image_url[0] . '"/></a>';
	endwhile;
endif;
