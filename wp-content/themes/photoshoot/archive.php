    	...
    	<div class="row">
		 	<div class="col-md-9">
            	<div class="photos-group">
                	<h2 class="photoshoot-title"><span class="title-color">
                    <?php 
                    
                  if ( is_day() ) :
            _e('Daily Archives','photoshoot'); echo " : ". get_the_date();
        elseif ( is_month() ) :
            _e('Monthly Archives','photoshoot'); echo " : ". get_the_date('F Y');
        elseif ( is_year() ) :
            _e('Yearly Archives','photoshoot'); echo " : ". get_the_date('Y');
        else :
            _e( 'Archives', 'photoshoot' );
        endif; 
