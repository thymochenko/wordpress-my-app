...
<div class="fasterthemes-themes">
  <form method="post" action="options.php" id="form-option" class="theme_option_ft">
    <div class="fasterthemes-header">
      <div class="logo">
        <?php
		$photoshoot_image=get_template_directory_uri().'/theme-options/images/logo.png';
		echo "<a href='http://fasterthemes.com' target='_blank'><img src='".$photoshoot_image."' alt='FasterThemes' /></a>";
		?>
      </div>
      <div class="header-right">
        <?php
			echo "<h1>". __( 'Theme Options', 'photoshoot' ) . "</h1>"; 			
      ...
      <div class="fasterthemes-options">
		...
		$photoshoot_options = get_option( 'photoshoot_theme_options' );?>
          ...
          <div id="options-group-1" class="group socialsettings faster-inner-tabs">
            ...
            <div class="section theme-tabs theme-logo"> <a class="heading faster-inner-tab active" href="javascript:void(0)"><?php _e('Site Logo','photoshoot') ?></a>
              <div class="faster-inner-tab-group active">
                <div class="ft-control">
                  <input id="logo-img" class="upload" type="text" name="photoshoot_theme_options[logo]" 
                            value="<?php if(!empty($photoshoot_options['logo'])) { echo esc_url($photoshoot_options['logo']); } ?>" placeholder="<?php _e('No file chosen','photoshoot') ?>" />
            ...
            <div class="section theme-tabs theme-favicon"> <a class="heading faster-inner-tab" href="javascript:void(0)"><?php _e('Favicon','photoshoot') ?></a>
              <div class="faster-inner-tab-group">
                ...
                <div class="ft-control">
                  <input id="favicon-img" class="upload" type="text" name="photoshoot_theme_options[favicon]" 
                    value="<?php if(!empty($photoshoot_options['favicon'])) { echo esc_url($photoshoot_options['favicon']); } ?>" placeholder="<?php _e('No file chosen','photoshoot') ?>" />
          ...
          <div id="options-group-2" class="group faster-inner-tabs">
            ...
            <div class="ft-control">
            <input id="slider-image-<?php echo $photoshoot_i;?>" class="upload" type="text" name="photoshoot_theme_options[slider-image-<?php echo $photoshoot_i;?>]" 
                value="<?php if(!empty($photoshoot_options['slider-image-'.$photoshoot_i])) { echo esc_url($photoshoot_options['slider-image-'.$photoshoot_i]); } ?>" placeholder="<?php _e('No file chosen','photoshoot') ?>" />
