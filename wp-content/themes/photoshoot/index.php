    	...
    	<div class="row">
		 	<div class="col-md-9">
            	<div class="photos-group">
                    <?php if(!empty($photoshoot_options['blogtitle'])): ?>
                    <h2 class="photoshoot-title"><span class="title-color"><?php echo esc_attr($photoshoot_options['blogtitle']); ?></span></h2>
                    <?php endif; ?>
                      <!--Pagination Start-->
                   ...
                   <!--Pagination End-->
                    ...
                    <div class="col-md-4 box no-padding">
                      <div class="article">
                        ...
                        <img src="<?php echo  esc_url($photoshoot_feat_image); ?>" class="img-responsive" alt="<?php echo get_the_title(); ?>" title="<?php echo get_the_title(); ?>">
                        </a>
