...
<?php printf( __( 'Powered by %1$s and %2$s.', 'photoshoot' ), '<a href="http://wordpress.org" target="_blank">WordPress</a>',
				'<a href="http://fasterthemes.com/wordpress-themes/photoshoot" target="_blank">Photoshoot</a>' );  ?>
