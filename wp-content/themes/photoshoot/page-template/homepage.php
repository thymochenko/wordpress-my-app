...
<div id="photoshootcarousel" class="carousel slide photoshoot-slider" data-interval="3000" data-ride="carousel"> 
  ...
  <div class="carousel-inner">
    ...
    <?php if(!empty($photoshoot_options['slider-image-'.$photoshoot_loop])){ 
...
<?php } ?>
        ...
        <div class="photos-group">
          ...
          <div id="latest-photos" class="owl-carousel photos-slider">
            ...
            <?php  $photoshoot_latest_image_array = wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'photoshoot-topphoto-width' ); 
