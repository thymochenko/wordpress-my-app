...
?><div class="details-right"><?php
	...
	?></div><div class="details-left"><?php
	$photoshoot_author = '<span>'.__('Author','photoshoot').':</span>'.sprintf( ' <a href="%1$s" title="%2$s" >%3$s</a>',
  ...
  ?></div> <?php
      ...
      $photoshoot_comment = '<div class="details-left"><span>'.__('Comments','photoshoot').':</span>'.sprintf( ' %1$s',
		get_comments_number()
	).'</div>';
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
  <p>
    ...
    <?php edit_comment_link( __( 'Edit', 'photoshoot' ), '<span class="edit-link">', '</span>' ); ?>
  </p>
</li>
<?php
			break;
