...
class photoshoot_info_widget extends WP_Widget {
    ...
    function photoshoot_info_widget() {
...
<p>
  <label for="<?php echo $this->get_field_id( 'facebook' ); ?>">
    <?php _e('Facebook url:', 'photoshoot_info'); ?>
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id( 'twitter' ); ?>">
    <?php _e('Twitter url:', 'photoshoot_info'); ?>
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id( 'linkedin' ); ?>">
    <?php _e('Linkedin url:', 'photoshoot_info'); ?>
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id( 'google' ); ?>">
    <?php _e('Google+ url:', 'photoshoot_info'); ?>
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id( 'pinterest' ); ?>">
    <?php _e('Pinterest url:', 'photoshoot_info'); ?>
  </label>
